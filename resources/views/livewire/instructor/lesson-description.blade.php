<div>
    <article class="card" x-data="{open: false}">
        <div class="card-body bg-gray-100">
            <header>
                <h1 class="cursor-pointer" x-on:click="open = !open "><i class="fas fa-text-width"></i> Descripcion de la leccion</h1>
            </header>
            ...
            <div x-show="open">
                ...
                @else
                    <div>
                        <textarea wire:model="name" class="form-input w-full" placeholder="Agregar una descripcion de la leccion..."></textarea>
