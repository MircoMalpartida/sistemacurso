<div class="container py-8">
    ...
    <x-table-responsive>
        ...
        <div class="px-6 py-4 flex">
            <input wire:keydown="limpiar_page" wire:model="search" class="form-input shadow-sm flex-1" placeholder="Ingrese nombre de un curso...">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    ...
                                    @else
                                    <img class="h-10 w-10 rounded-full object-cover object-center" src="https://images.pexels.com/photos/5940721/pexels-photo-5940721.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260" alt="">                                    @endisset
                                </div>
                                <div class="ml-4">
