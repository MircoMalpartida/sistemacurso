<div class="mt-8">
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            ...
            {{--MARCAR CLASE CULMINADA--}}
                <div class="flex items-center cursor-pointer" wire:click="completed">
                    ...
                    @endif
                    <p class="text-sm ml-2">Marcar como clase culminada</p>
                </div>

                @if ($current->resource)
                    <div wire:click="download" class="flex items-center text-gray-600">
        ...
        <div class="card">
            <div class="card-body">
                <h1 class="tesxt-2xl leading-8 text-center mb-4">{{$course->title}}</h1>
                <div class="flex items-center">
                    <figure>
                        <img class="w-12 h-12 object-cover rounded-full mb-4" src="{{$course->teacher->profile_photo_url}}" alt="">
                    </figure>
                    <div>
